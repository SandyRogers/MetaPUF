...
def get_args():
    ...
    parser.add_argument('-p', '--params', dest='parameter', help="the parameters for SearchGUI")
...
def searchgui_decoy(jar_file, info_file, human_db, crap_db, parameters):
    """
...
def main():
    ...
    searchgui_decoy(args.jar_file, args.info_file, args.human_db, args.crap_db, args.parameter)
